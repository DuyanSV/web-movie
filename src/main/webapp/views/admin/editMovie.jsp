...
<div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen}">
    <div class="flex flex-col flex-1 w-full">
        <div class="container px-6 mx-auto grid">
            ...
            <form method="post" action="<c:url value="/admin/phim/edit"/>" enctype="multipart/form-data">
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <div class="row">
                        <div class="col-lg-7">
                            <label class="block text-sm">
                                <span class="text-gray-700 dark:text-gray-400">Tên phim</span>
                                <input name="name" value="${movie.name}" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                ...
                                <div class="col-lg-6">
                                    <label class="block text-sm">
                                        ...
                                        <input type="text" name="duration" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                            value="${movie.duration}"    placeholder="Thời lượng"/>
                                    </label>
                                </div>
                                <div class="col-lg-6">
                                    <label class="block text-sm">
                                        ...
                                        <input type="text" name="quality" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                             value="${movie.quality}"  placeholder="Số tập"/>
                                    </label>
                                </div>
                            </div>
                            <br/>
                            <label class="block text-sm">
                                ...
                                <input name="dateAired1" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                   value="${movie.getDefaultDate()}" placeholder="Ngày phát sóng" type="date"/>
                            </label>
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                >${theloai}</textarea>
                                <input type="hidden" name="theLoaiOut" value="${genre}">
                                <br/>
                                <div class="row">
                                    <div class="col-lg-7">
                        ...
                        <div class="col-lg-5">
                            ...
                            <img id="imgChon1" src="<c:url value="/images/banner/${movie.banner}" />" alt=""
                            ...
                            <img id="imgChon2" src="<c:url value="/images/thumnail/${movie.thumbnail}" />" alt=""
                    ...
                    <div id="validateAddPhim" style="width: 150px" class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                        Lưu cập nhật
                    </div>
                </div>
            </form>
...
<script src="<c:url value="/template/validate/validateEditPhim.js"/> "></script>
</body>
</html>
